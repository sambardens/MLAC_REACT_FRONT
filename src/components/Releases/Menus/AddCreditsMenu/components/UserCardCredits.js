...
const UserCardCredits = ({ onSelect, onDelete, user, isInvitedUser, w, showEmail = false }) => {
	const registeredUser = user?.firstName && user?.lastName;
	const onClick = () => {
...
export default UserCardCredits;
